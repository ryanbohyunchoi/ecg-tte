...
Current user-selected starting population: [broad COMET-inspired HF OR EF<40 cohort](docs/COMET_SELECTED_EXPLORATORY_COHORT.md), 6,530 exploratory candidates after diastolic/HFpEF exclusions, before further eligibility checks.
